...
export default function MenuPage() {
  ...
  const spirits = [
    ...
    { category: "Whiskey", items: ["Johnnie Walker Black", "Jack Daniel's", "Macallan 12"] },
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/10 to-background">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl sm:text-5xl font-bold mb-4 text-foreground">Our Menu</h1>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Discover our carefully crafted cocktails, premium spirits, and refreshing beverages
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-foreground">Signature Cocktails</h2>
              ...
              {cocktails.map((cocktail) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-muted-foreground mb-4">{cocktail.description}</p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-card/50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-foreground">Premium Spirits</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {spirits.map((spirit) => (
                <div key={spirit.category} className="bg-background rounded-lg p-6 border border-border">
                  <h3 className="text-lg font-bold text-primary mb-4">{spirit.category}</h3>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4 text-foreground">Ready to Experience Bar Melo?</h2>
            <p className="text-lg text-muted-foreground mb-8">
              Book your table now and enjoy our premium selection in an unforgettable atmosphere
            </p>
